...
<header class="header-box">
	<div class="header-container">
		<a href="${pageContext.request.contextPath }" class="header-brand"> <img
		...
		<nav class="header-nav">
			<ul class="head-container">
				<li class="head-item"><a href="${pageContext.request.contextPath }/html/member/login.jsp" class="head-link"> 로그인 </a></li>
				<li class="head-item"><a
					href="html/member/join.jsp"
